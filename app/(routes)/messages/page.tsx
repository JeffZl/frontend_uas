...
export default function MessagesPage() {
  ...
  const getAvatarUrl = (profilePicture?: { url: string }, name?: string) => {
    if (profilePicture?.url) return profilePicture.url;
    return `https://robohash.org/${name || "user"}.png?size=50x50`;
  };
  ...
  return (
    <div className="flex h-screen bg-black text-white">
      {/* Conversations List */}
      <div className="w-96 border-r border-[#2f3336] flex flex-col">
          ...
          {loading ? (
            ...
            conversations.map((conv) => (
              <button
                ...
                className={`w-full flex items-center gap-3 p-4 hover:bg-[#0f0f0f] transition ${
              ...
              >
                {conv.participant.profilePicture?.url ? (
                  ...
                  <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-700 flex-shrink-0">
      ...
      <div className="flex-1 flex flex-col">
        {selectedConversation ? (
          <>
            {/* Header */}
            <div className="p-4 border-b border-[#2f3336] flex items-center gap-3">
            ...
            <form
              ...
              className="p-4 border-t border-[#2f3336] flex gap-3"
            >
              <input
                type="text"
                value={messageInput}
                ...
                className="flex-1 bg-[#202327] text-white px-4 py-2 rounded-full outline-none placeholder-gray-500"
                disabled={sending}
              />
              <button
                type="submit"
                disabled={!messageInput.trim() || sending}
                className="bg-white text-black font-bold px-6 py-2 rounded-full hover:bg-gray-200 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
